...
//        property real dh: 320;
        ...
        onPaint: {
            ...
            {
                /*矩形宽,高,位置*/
                rectHeight = rectWidth = oldRectX + oldRectWidth - frameX;


                /*矩形左上角位置*/
                rectX = oldRectX + oldRectWidth/2 - rectWidth / 2;
                rectY = oldRectY + oldRectWidth/2 - rectWidth / 2;
            }
            ...
            {
                /*矩形宽高位置*/
                rectHeight = rectWidth = frameX - oldRectX;
                //rectHeight = frameY;
            ...
            {
                /*矩形宽高位置*/
                rectWidth = rectHeight = oldRectY + oldRectHeight - frameY;  //底边-顶边
            ...
            {
                /*矩形宽高位置*/
                rectWidth = rectHeight = frameY - oldRectY;                 //底边-顶边
            ...
            {
                /*矩形宽高位置*/
                rectHeight = rectWidth  = oldRectX - frameX + oldRectWidth;
            ...
            {
                /*矩形宽高位置*/
                rectWidth = rectHeight = frameY -oldRectY;  //新点，坐标加减
            ...
            ctx.ellipse(rectX, rectY, rectWidth, rectHeight)
            ctx.fill();
            ctx.stroke();
            ctx.closePath();                /*结束绘制*/
